...
<div id="publishPanel">
    ...
    <ul class="nav nav-tabs">
        ...
        <li><a href="#publicUrlTab" data-toggle="pill">URL Publique</a></li>
    </ul>
    <br/>
    <div class="tab-content">
        <div class="tab-pane fade active in" id="embedTab">
            ...
            <label><spring:message code="BLOG_SNIPPET"/></label>
                <textarea readonly="readonly" style="cursor: text; font-family: monospace;resize: none" class="form-control" id="embedCode">&lt;iframe style="width:600px;height:400px;border: 1px
solid black" src="${baseUrl}/c/maps/${mindmap.id}/embed?zoom=1"&gt; &lt;/iframe&gt;</textarea>
        </div>

        <div class="tab-pane fade" id="publicUrlTab">
            <p>Copiez-collez le lien ci-dessous pour le partager</p>
