...
<div>
    <ul class="nav nav-tabs">
        ...
        <c:if test="${principal.databaseSchema}">
            <li><a href="#deleteAccountPanel" data-toggle="pill">Supprimer mon compte</a></li>
        </c:if>
    </ul>
    ...
    <div class="tab-content" style="padding-top:15px;">
        ...
        <div class="tab-pane fade" id="deleteAccountPanel">
            <div id="deleteAccountMsg" class="alert alert-danger" style="display: block;">
                 Si vous ne souhaitez plus utiliser votre compte Framindmap, vous pouvez le supprimer ici.
                 Sachez cependant qu'une fois que vous aurez supprimé votre compte, vous ne pourrez plus récupérer vos cartes ni les consulter.
                 <br /><br />
                 Pour supprimer votre compte, cochez la case ci-dessous et cliquez sur le bouton « Je supprime mon compte »</div>
