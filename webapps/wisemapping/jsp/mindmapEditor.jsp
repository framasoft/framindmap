...
<head>
    ...
    <title>Framindmap - <c:out value="${mindmap.title}"/></title>
    <!--[if lt IE 9]>
...
<div id="header">
    <div id="headerInfo">
        ...
        <a href="${requestScope['site.homepage']}">
            <h1 style="font-family: &quot;DejaVu Sans&quot;,&quot;Verdana&quot;,&quot;Geneva&quot;,&quot;sans serif&quot;;font-weight: bold; font-size:30px; float:left"><span style="color: #6A5687;">Fra</span><span style="color: #9BAE5F;">mindmap</span></h1>
        </a>
