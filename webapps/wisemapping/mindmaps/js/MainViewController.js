...
mindmaps.MainViewController = function(eventBus, mindmapModel, commandRegistry) {
  ...
  canvasContainer.receivedFileDrop = function(result) {
    try {
      ...
      eventBus.publish(mindmaps.Event.NOTIFICATION_ERROR, "Impossible de lire le fichier.");
      console.warn("Impossible d'ouvrir une carte mentale par glisser-d\351poser.");
    }
  };
  ...
  this.go = function() {
    ...
    var inspectorPanel = fpf
        .create("Contr\364leur", inspectorView.getContent());
    inspectorPanel.show();
    ...
    var navigatorPanel = fpf.create("Navigateur", naviView.getContent());
    navigatorPanel.show();
